  ...
  return (
    ...
    >
      ...
      <motion.p
        ...
        className="text-base text-center text-gray-500 max-w-lg mt-6"
      >
        Consulta tablero interactivo, navegando por indicadores BI y conoce en
        detalle la evolución del sector energético nacional.
      </motion.p>
