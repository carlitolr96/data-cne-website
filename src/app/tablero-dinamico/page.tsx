  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="group flex items-center gap-2 rounded-full p-1 pr-3 mt-44 text-primary bg-white/20 backdrop-blur-md border-1 border-white/30"
      >
      ...
      <h1 className="text-5xl leading-[68px] md:text-6xl md:leading-[84px] font-medium max-w-2xl text-center text-gray-500">
        Free template to start your{" "}
        <span className="bg-gradient-to-r text-white from-primary to-blue-300 px-3 rounded-xl whitespace-nowrap">
          Next.js site.
        </span>
      </h1>
      ...
      <div className="relative w-full max-w-4xl mt-16 h-[343px] overflow-hidden px-3 pt-3 rounded-t-3xl">
