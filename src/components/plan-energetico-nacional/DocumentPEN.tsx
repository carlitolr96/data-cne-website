...
export default function DocumentPEN() {
  return (
    <div className="relative bg-white w-full py-10 md:py-5 min-h-[75vh] sm:min-h-[45vh] md:min-h-[35vh] lg:min-h-[25vh] xl:min-h-[20vh] flex items-end md:items-center">
