...
const locations: LocationPoint[] = [
  { id: "santo-domingo", name: "Santo Domingo", description: "Capital del país con proyectos solares y eólicos en marcha.", x: 55, y: 60 },
  { id: "santiago", name: "Santiago", description: "Centro de proyectos hidroeléctricos en la zona norte.", x: 40, y: 35 },
  { id: "punta-cana", name: "Punta Cana", description: "Expansión de energía renovable para turismo sostenible.", x: 80, y: 65 },
  { id: "san-cristobal", name: "San Cristobal", description: "Expansión de energía renovable para turismo sostenible.", x: 50, y: 65 },
];
        ...
        <div className="relative z-10 min-h-screen flex items-start justify-end pt-16 md:pt-60 pr-6 md:pr-12">
          <div className="flex flex-col items-end max-w-md">
            <div className="flex items-center gap-2 bg-red px-4 py-2 mb-6">
              ...
              <span className="text-white font-bold text-md md:text-4xl uppercase">EN CONSTRUCCIÓN</span>
            </div>

            <div className="text-left">
              <h2 className="text-primary text-3xl md:text-4xl lg:text-4xl font-extrabold leading-tight">XX PROYECTOS</h2>
              <p className="text-primary text-base md:text-lg mb-12">
                que aportarán <span className="font-extrabold text-primary">xxx</span>
              </p>
            </div>

            <div className="flex flex-col items-end mt-auto">
              <p className="text-lg font-medium text-primary mb-3 text-right">Para más información</p>
              <Boton href="/" icon="TapIcon" iconPosition="right">Ir al tablero</Boton>
            </div>
          </div>
        </div>
      </div>
