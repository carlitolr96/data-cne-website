    ...
    <section className="bg-white py-16">
      <div className="max-w-7xl mx-auto px-6 md:px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-15 mb-16">
          <div className="border-l-4 border-[#FF9000] pl-6">
            ...
            ${
              step.number <= currentStep
                ...
                : "bg-gray-300 text-gray-500 border border-gray-300"
                  ...
                  <h4 className="text-primary font-bold text-sm mt-2 text-center whitespace-normal break-words">
                    {step.title}
                  </h4>
                </div>

                {index < steps.length - 1 && (
                  <div className="h-10 w-1 bg-gray-300 my-2" />
                )}
              </React.Fragment>
            ))}
          </div>
