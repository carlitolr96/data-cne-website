...
export default function StorySession() {
  return (
    <section className="relative w-full flex items-center justify-center sm:justify-start overflow-hidden h-[400px] sm:h-[410px] md:h-[600px] bg-[url('/TowerSolar.jpg')] bg-cover bg-center">
